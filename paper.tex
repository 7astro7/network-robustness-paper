...
\begin{itemize}
    \item Uniform failure: each node is removed with probability $q$.
    \item Degree-biased failure: a node with degree $k$ fails with probability $q(k) \propto k^\alpha$, $\alpha \in \{-1,0,1\}$.
\end{itemize}
